...
import talentMobile from "../../../assets/images/about/mobile/image-world-class-talent.jpg";import talentTablet from "../../../assets/images/about/tablet/image-world-class-talent.jpg";
...
export const aboutData = {
  sectionOne: {
    header: "About Me",
    content: {
      p1: "Since 2015, I am a creative developer that produces lasting results for my clients. I’ve partnered with many startups, corporations, and nonprofits alike to craft designs that make real impact. I am always looking forward to creating brands, products, and digital experiences that connect with my clients’ audiences.",
    },
    image: {
